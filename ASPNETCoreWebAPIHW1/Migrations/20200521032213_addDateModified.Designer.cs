...
namespace ASPNETCoreWebAPIHW1.Migrations
{
    ...
    [Migration("20200521032213_addDateModified")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPNETCoreWebAPIHW1.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("ASPNETCoreWebAPIHW1.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASPNETCoreWebAPIHW1.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("ASPNETCoreWebAPIHW1.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("ASPNETCoreWebAPIHW1.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASPNETCoreWebAPIHW1.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("ASPNETCoreWebAPIHW1.Models.Course", b =>
                {
                    b.HasOne("ASPNETCoreWebAPIHW1.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("ASPNETCoreWebAPIHW1.Models.CourseInstructor", b =>
                {
                    b.HasOne("ASPNETCoreWebAPIHW1.Models.Course", "Course")
                    ...
                    b.HasOne("ASPNETCoreWebAPIHW1.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("ASPNETCoreWebAPIHW1.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("ASPNETCoreWebAPIHW1.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("ASPNETCoreWebAPIHW1.Models.OfficeAssignment", b =>
                {
                    b.HasOne("ASPNETCoreWebAPIHW1.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("ASPNETCoreWebAPIHW1.Models.OfficeAssignment", "InstructorId")
