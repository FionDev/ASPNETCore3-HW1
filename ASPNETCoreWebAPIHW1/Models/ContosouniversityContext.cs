...
namespace ASPNETCoreWebAPIHW1.Models
{
    public partial class ContosouniversityContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=DESKTOP-PGK7AIU\MSSQLSERVER01;Database=ContosoUniversity;Integrated Security=true;");
        }
        */
